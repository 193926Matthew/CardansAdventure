...
public class SnowBossTileset extends Tileset {

    public SnowBossTileset() {
        super(ImageLoader.load("SnowBossTileset.png"), 48, 48, 1);
    }
    ...
    public ArrayList<MapTileBuilder> defineTiles() {
        ...
        // Animated Water 
        Frame[] animatedwaterFrame1 = new Frame[] {
        ...
        MapTileBuilder animatedwaterTile1 = new MapTileBuilder(animatedwaterFrame1);

        mapTiles.add(animatedwaterTile1);

                // Animated Water 
        Frame[] animatedwaterFrame2 = new Frame[] {
                new FrameBuilder(getSubImage(5, 1), 65)
                        .withScale(tileScale)
                        .build(),
                new FrameBuilder(getSubImage(5, 2), 65)
        ...
        MapTileBuilder animatedwaterTile2 = new MapTileBuilder(animatedwaterFrame2);

        mapTiles.add(animatedwaterTile2);

                // Animated Water 
        Frame[] animatedwaterFrame3 = new Frame[] {
                new FrameBuilder(getSubImage(5, 2), 65)
                        .withScale(tileScale)
                        .build(),
                new FrameBuilder(getSubImage(5, 3), 65)
        ...
        MapTileBuilder animatedwaterTile3 = new MapTileBuilder(animatedwaterFrame3);

        mapTiles.add(animatedwaterTile3);

                // Animated Water 
        Frame[] animatedwaterFrame4 = new Frame[] {
                new FrameBuilder(getSubImage(5, 3), 65)
                        .withScale(tileScale)
                        .build(),
                new FrameBuilder(getSubImage(5, 4), 65)
        ...
        MapTileBuilder animatedwaterTile4 = new MapTileBuilder(animatedwaterFrame4);

        mapTiles.add(animatedwaterTile4);

                // Animated Water 
        Frame[] animatedwaterFrame5 = new Frame[] {
                new FrameBuilder(getSubImage(5, 4), 65)
                        .withScale(tileScale)
                        .build(),
                new FrameBuilder(getSubImage(5, 5), 65)
        ...
        MapTileBuilder animatedwaterTile5 = new MapTileBuilder(animatedwaterFrame5);

        mapTiles.add(animatedwaterTile5);

                // Animated Water 
        Frame[] animatedwaterFrame6 = new Frame[] {
                new FrameBuilder(getSubImage(5, 5), 65)
                        .withScale(tileScale)
                        .build(),
                new FrameBuilder(getSubImage(5, 0), 65)
        ...
        MapTileBuilder animatedwaterTile6 = new MapTileBuilder(animatedwaterFrame6);

        mapTiles.add(animatedwaterTile6);

                // Animated Water 
        Frame[] animatedwaterFrame = new Frame[] {
                new FrameBuilder(getSubImage(5, 0), 65)
                        .withScale(tileScale)
                        .build(),
                new FrameBuilder(getSubImage(5, 1), 65)
        ...
        MapTileBuilder animatedwaterTile = new MapTileBuilder(animatedwaterFrame);

        mapTiles.add(animatedwaterTile);
